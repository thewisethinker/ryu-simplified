...
class SimpleSwitch(app_manager.RyuApp):
	...
	if arp_head:
	    ...
	    srcarpip.append(src_ip)
	    srcarpmac.append(eth.src)		
	elif ipv4_header:
	...
	for i in blocked_ip:
	    if i in srcarpip:
		index = srcarpip.index(i)
	        mac_to_block.append(srcarpmac[index])	
	if arp_head:        
	    print(mac_to_block)
	if src in mac_to_block:
	    actions = []
	else:
	    actions = [datapath.ofproto_parser.OFPActionOutput(out_port)]
	"""        
